...
public class ConnectionUtils {
    ...
    public void insertData(List<User> list) throws Exception{
    	 for(User user:list)
    	 {
	    	 ...
	    	 try {
	    		 pStatement= connection.prepareStatement("INSERT INTO t_order(user_id, status) VALUES(?,?)");
	    		 pStatement.setInt(1, Integer.parseInt(user.getName()));
	    		 pStatement.setString(2,"INSERT_TEST");
	    		 pStatement.addBatch();
	    		 
	    		 
//	    		 pStatement= connection.prepareStatement("INSERT INTO t_order_item(order_id, user_id) VALUES(?,?)");
//	    		 pStatement.setInt(1,user.getAge());
//	    		 pStatement.setInt(2,Integer.parseInt(user.getName()));
//	    		 pStatement.addBatch();
